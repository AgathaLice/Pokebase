...
class View():
    ...
    def inicia(self):
        ...
        self.levantarTela(self.listagem) #! Estou trabalhando nessa tela atualmente.
    ...
    def telaListagem(self, root):
        ...
        #TODO -> Colocar tudo dentro de um único for loop
        ...
        voltarMenu = tk.Button(botoesFrame,
                               text="Voltar ao Menu",
                               command=lambda: self.levantarTela(self.menu))
